# Adapted Powerlevel10k configuration on 2023-03-06.
# Adapted fromm Jaseem Abid's dotfiles
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    os_icon                 # os identifier                                           ## Changed from adopteed
  ...
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=232 # 232
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=4   # 7
  # Custom icon.
